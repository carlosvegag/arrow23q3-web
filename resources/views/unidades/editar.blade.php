                            ...
                            <div class="col-md-12">                                                                          
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <strong> Nombre </strong>
                                                <input type="text" class="form-control" value="{{$unidad->nombre}}" id="nombre" name="nombre">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    @foreach ($empresas as $empresa)
                                     <option value="{{$empresa->id}}" @if($empresa->nombre == $empresaUni->nombre) selected @endif >{{$empresa->nombre}}</option>
                                     @endforeach
                                    </select>
                                    </div>
                                </div>
