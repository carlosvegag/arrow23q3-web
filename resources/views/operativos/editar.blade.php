                            ...
                            <div class="col-md-12">           
                                ...
                                <strong> Empresa </strong>
                                    ...
                                    <select class="form-control show-tick "  name="empresa" id="em">
                                     ...
                                     <option value="{{$empresau->id}}" selected>{{$empresau->nombre}}</option>
                                ...
                                <strong> Empresa </strong>
                                    ...
                                    @foreach ($empresasus as $empresa)
                                     <option value="{{$empresa->id}}" @if($empresa->nombre == $empresau->nombre) selected @endif >{{$empresa->nombre}}</option>
                                     @endforeach
                                    </select>
                                    </div>
                                </div>
