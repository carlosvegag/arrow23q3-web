                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <strong> Domicilio </strong>
                                            <textarea  style="height: 100px" class="form-control"   id="domicilio" name="domicilio">{{ $afianzadora->domicilio }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <strong> Télefono </strong>
                                            <input type="text" class="form-control"  value="{{ $afianzadora->telefono }}"  id="telefono" name="telefono" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    ...
                                    @foreach ($empresas as $empresa)
                                     <option value="{{$empresa->id}}" @if($empresa->nombre == $empresaAfi->nombre) selected @endif >{{$empresa->nombre}}</option>
                                     @endforeach
                                    </select>
                                    </div>
                                </div>
