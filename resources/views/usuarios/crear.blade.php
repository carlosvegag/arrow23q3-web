					...
					<div class="body">                        
                        <div class="row clearfix">
                            ...
                            {!! Form::open(array('route' => 'usuarios.store','method' => 'POST', 'file' => true, 'enctype' => 'multipart/form-data' )) !!}
                                ...
                                {{-- <div class="col-sm-6 ">
                                    {!! Form::select('empresas[]->id', $empresas,[],array('class' => 'form-control show-tick' ) ) !!}
                                </div> --}}
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input filled-in" type="checkbox" name="empresa[]" value="{{$empresa->id}}" id="{{$empresa->id}}">
