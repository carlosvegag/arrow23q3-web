                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-6 m-auto">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" class="form-control"  name="hombro_derecho1" value="{{$dato->hombro_derecho1}}" placeholder="Hombro Derecho 1">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 m-auto">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" class="form-control"  name="hombro_derecho2" value="{{$dato->hombro_derecho2}}" placeholder="Hombro Derecho 2">
                                                    </div>
                                                </div>
                                            </div>
