...
class ConceptoController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function create($concepto)
    {
    ...
    public function show($id)
    {
        ...
        $concep=DB::table('unidad')->select('conceptos.codigo','conceptos.id_codigo','conceptos.id','conceptos.cantidad',
        'conceptos.punitario','conceptos.precio_letra','conceptos.importe','conceptos.porcentaje',
        'conceptos.estatus','conceptos.concepto','id_unidad as id_uni','nombre as nombre_unidad')
        ->join('conceptos', 'unidad.id','=','conceptos.id_unidad')
        ->where('id_codigo','=',$con->id)->get()->toArray();
        $conceptoshij = array_merge_recursive($conceptoshij, $concep);
        }
        unset($valor);
        ...
        return view('conceptos.listaConceptos',compact('conceptos','concepto','conceptoshij'));
    }
    ...
    public function crear($id){
        ...
        $conceptos=DB::table('conceptos')
            ->where('id_codigo','=',$concepto->id)
            ->orwhere('id','=',$concepto->id)->get();

        // return $unidades;
        


        return view('conceptos.crear',compact('concepto','unidades','conceptos'));
    }
