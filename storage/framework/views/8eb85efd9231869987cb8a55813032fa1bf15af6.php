                                ...
                                <div class="row m-2">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                            ...
                                            <select class="form-control show-tick" id="cliente" name="id_cliente" required>
                                                <option value="0" selected>--Seleccione un empleado por cliente--</option>
                                                 ...
                                                 <?php $__currentLoopData = $empleadosC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <select class="form-control show-tick" id="empresa" name="id_empresa" style="display: none" required>
                                            ...
                                            <?php $__currentLoopData = $empleadosE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projectarrow/resources/views/asignarcargo/crear.blade.php ENDPATH**/ ?>