    ...
    <div class="row clearfix">
        <div class="col-lg-7 col-md-12 col-sm-12">
            <div class="card">
                ...
                <a href="<?php echo e(route('conceptosec.show',$p)); ?>" class="btn btn-raised btn-light m-auto " ><i class="material-icons">arrow_back</i></a>
                   
                <a class="btn btn-sm btn-raised btn-primary m-auto" href="<?php echo e(route('concepto.createPDF',$avancef->id)); ?>">Imprimir Reporte<i class="material-icons" style=" margin-bottom: 8px;">file_download</i> </a>
                    
                </div>
                <div class="clearfix d-flex justify-content-center">
                <h2 class=" justify-content-center">Información</h2>
                ...
                <div class="body">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-3  m-auto text-center">
                            ...
                            <strong><?php echo e($avance->nom_concepto); ?></strong>
                        </div>
                    ...
                    <div class="col text-center">
                        ...
                        <a href="<?php echo e(route('ver.avance',$avancef->id)); ?>" class="btn btn-raised btn-warning m-auto">Ver el registro avance</a> <hr>                         
                        <a href="<?php echo e(route('avances.agregarimagenubi',$avancef->id)); ?>" class="btn btn-raised btn-success m-auto"> Imagenes de avance</a><hr>                    
                        <a href="<?php echo e(route('avancespdf.createPDFAvance',$avancef->id)); ?>" class="btn btn-raised g-bg-blush2 m-auto"> Imprimir avance</a> 
...
//           var marcadores=<?php echo json_encode($imagenesavances); ?>;

//           var ventanaInfo= <?php echo json_encode($imagenesavances); ?>;
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/avances/show.blade.php ENDPATH**/ ?>