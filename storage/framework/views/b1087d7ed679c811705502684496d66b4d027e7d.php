                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <strong> Apellido Paterno </strong>
                                            <input type="text" class="form-control"  id="apellido_paterno"  value="<?php echo e(old('apellido_paterno')); ?>" name="apellido_paterno" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <strong> Apellido Materno </strong>
                                            <input type="text" class="form-control"  id="apellido_materno" value="<?php echo e(old('apellido_materno')); ?>" name="apellido_materno" >
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <strong> Número telefonico de Casa </strong>
                                                <input type="text" class="form-control"  id="num_casa" value="<?php echo e(old('num_casa')); ?>" name="num_casa" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <strong> Número telefonico de Celular </strong>
                                                <input type="text" class="form-control"  id="num_cel" value="<?php echo e(old('num_cel')); ?>" name="num_cel">
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/empleados/crear.blade.php ENDPATH**/ ?>