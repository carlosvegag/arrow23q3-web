                            ...
                            <form action="<?php echo e(route('empleados.store')); ?>" method="POST">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control"  id="nombre" name="nombre" value="<?php echo e(old('nombre')); ?>" placeholder="Nombre" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control"  id="apellido_paterno"  value="<?php echo e(old('apellido_paterno')); ?>" name="apellido_paterno" placeholder="Apellido paterno" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control"  id="apellido_materno" value="<?php echo e(old('apellido_materno')); ?>" name="apellido_materno" placeholder="Apellido Materno" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row m-2">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control"  id="num_casa" value="<?php echo e(old('num_casa')); ?>" name="num_casa" placeholder="Ingrese su número de casa*" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control"  id="num_cel" value="<?php echo e(old('num_cel')); ?>" name="num_cel" placeholder="Ingrese su número telefonico" >
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control show-tick" id="empresa" name="id_empresa" style="display: none" required>
                                        ...
                                        <option value="<?php echo e($empresa->id); ?>" id="opc"><?php echo e($empresa->nombre); ?></option>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projectarrow/resources/views/empleados/crear.blade.php ENDPATH**/ ?>