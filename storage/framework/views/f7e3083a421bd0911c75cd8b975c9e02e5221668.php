        ...
        <div class="col-lg-9 col-md-12 col-sm-12 m-auto text-center" >
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <p>Cliente</p>
                    <strong>Nombre del Cliente:</strong> <p><?php echo e($cliente->nombre); ?></p>
                    <?php else: ?>
                    <p>Empresa</p>
                    <strong>Nombre de la Empresa:</strong><p><?php echo e($empresa->nombre); ?></p>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/empleados/show.blade.php ENDPATH**/ ?>