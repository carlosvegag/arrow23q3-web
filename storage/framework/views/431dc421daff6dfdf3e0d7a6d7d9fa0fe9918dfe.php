            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="col-3">
                        ...
                        <a href="<?php echo e(route('codigos.edit',$codigo)); ?>" class="btn  btn-raised btn-info waves-effect">Editar concepto</a>
                        <?php endif; ?>
                    </div>
                </div>
                                    ...
                                    <div class="panel panel-col-grey">
                                        ...
                                        <div id="<?php echo e($concepto->codigo); ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_17">
                                            <div class="panel-body d-flex flex-wrap justify-content-center "> 
                                                ...
                                                <form action="<?php echo e(route('secundario.delete',$concepto->id)); ?>" class="d-flex flex-wrap justify-content-center "  method="post">
                                                    <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                        <td><?php echo e($concepto->concepto); ?></td>
                                         ...
                                         <td class="d-flex justify-content-around">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear-concepto')): ?>
                                                <a class="btn  btn-raised btn-info waves-effect" href="<?php echo e(route('concepto.create',$concepto->id)); ?>" >
                                                <i class="material-icons mb-1">library_add</i>
                                                </a>
                                                <?php endif; ?> 
                                                <a href="<?php echo e(route('conceptosec.show',$concepto->id)); ?>" class="btn  btn-raised btn-success waves-effect">
                                                <i class="material-icons mb-1">format_list_bulleted</i>
                                                </a>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-concepto')): ?>
                                                <a class="btn btn-raised bg-amber btn-sm text-center " href="<?php echo e(route('concepto.edit',$concepto->id)); ?>">
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/conceptos/index.blade.php ENDPATH**/ ?>