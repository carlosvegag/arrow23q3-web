                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        <form action="<?php echo e(route('Avance.update',$dato->id)); ?>" method="POST">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-6 m-auto">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" class="form-control"  name="hombro_derecho1" value="<?php echo e($dato->hombro_derecho1); ?>" placeholder="Hombro Derecho 1">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 m-auto">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" class="form-control"  name="hombro_derecho2" value="<?php echo e($dato->hombro_derecho2); ?>" placeholder="Hombro Derecho 2">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-6 m-auto">
                                                <div class="form-group">
                                                    <b>Ancho 1</b>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" value="<?php echo e($dato->ancho1); ?>"  name="ancho1" placeholder="ancho1">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 m-auto">
                                                <div class="form-group">
                                                    <b>Ancho 2</b>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" value="<?php echo e($dato->ancho2); ?>"  name="ancho2" placeholder="ancho2">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <?php if($al==1): ?>
                                            <div class="col-md-6 m-auto">
                                                <div class="form-group">
                                                    <b>Altura</b>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control"   value="<?php echo e($dato->altura); ?>"  name="altura" placeholder="altura">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 m-auto">
                                                <div class="form-group">
                                                    <b>Ancho </b>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control"  value="<?php echo e($dato->anchot); ?>" name="anchot" placeholder="Ancho ">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php endif; ?>
                                            ...
                                            <?php if($pie==1): ?>
                                                <div class="col-md-6 m-auto">
                                                    <div class="form-group">
                                                        <b>Pieza</b>
                                                        <div class="form-line">
                                                            <input type="number" class="form-control" value="<?php echo e($dato->pieza); ?>"  name="pieza" placeholder="pieza">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 m-auto">
                                                    <div class="form-group">
                                                        <b>Espesor </b>
                                                        <div class="form-line">
                                                            <input type="text" class="form-control"  value="<?php echo e($dato->espesor); ?>" name="espesor" placeholder="Ancho ">
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projectarrow/resources/views/avances/editaravance.blade.php ENDPATH**/ ?>