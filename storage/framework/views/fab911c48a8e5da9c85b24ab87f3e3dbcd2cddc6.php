				...
				<div class="card">
					...
					<div class="body">
                        <div class="row clearfix">
                            ...
                            <?php endif; ?>
                            <div class="col-md-12">
                                <form action="<?php echo e(route('conceptosec.guardarimagen')); ?>" method="POST" file="true" enctype="multipart/form-data">

                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="id_concepto" value="<?php echo e($id); ?>">
                                <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                                    <img id="imagenSeleccionada" style="max-height: 200px;">
                                </div>
                                <br>
                                <br>
                                <label class="text-center">Ingresa plano:</label>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/conceptos/imagen.blade.php ENDPATH**/ ?>