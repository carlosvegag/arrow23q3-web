				...
				<div class="card">
					...
					<div class="body">
                        <div class="row clearfix">
                            ...
                            <?php endif; ?>
                            <div class="col-md-12">
                            <form action="<?php echo e(route('asignarcargo.update', $asignarcargo->id)); ?>" method="POST">
                                    ...
                                    <strong> Cargo </strong>
                                        <div class="form-group drop-custum">
                                            ...
                                            <option value="0" selected>--Seleccione un cargo--</option>
                                              ...
                                              <option value="<?php echo e($cargo->id); ?>" <?php if($asignarcargo->id_cargo == $cargo->id): ?> selected  <?php endif; ?>   ><?php echo e($cargo->nombre_cargo); ?></option>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            </div>
                                    </div>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/asignarcargo/editar.blade.php ENDPATH**/ ?>