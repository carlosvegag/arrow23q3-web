                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <a href="<?php echo e(route('Avance.show',$avance->id_concepto)); ?>" class="btn btn-raised btn-default waves-effect">Cancelar</a>
                                    </center>
                                </div>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/avances/editarimage.blade.php ENDPATH**/ ?>