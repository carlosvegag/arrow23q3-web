				...
				<div class="card">
					...
					<div class="body">                        
                        <div class="row clearfix">
                            ...
                            <?php endif; ?>
                            <div class="col-md-12">                                                                          
                            <?php echo Form::open(array('route' => 'operativos.store','method' => 'POST', 'file' => true, 'enctype' => 'multipart/form-data' )); ?>

                                <?php echo csrf_field(); ?>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control"  id="name" name="name" placeholder="Nombre"   value="<?php echo e(old('name')); ?>"required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="email" name="email" placeholder="Correo" value="<?php echo e(old('email')); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <option value="0" selected>--Seleccione un rol--</option>
                                     ...
                                     <option value="<?php echo e($rol->name); ?>"value="<?php echo e(old('name')); ?>" ><?php echo e($rol->name); ?></option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                                    </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 " id="empresa" style="display:inline-block">
                                    ...
                                    <select class="form-control show-tick "  name="empresa" id="em">
                                     ...
                                     <option value="<?php echo e($empresa->id); ?>" value="<?php echo e(old('name')); ?>" selected><?php echo e($empresa->nombre); ?></option>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projectarrow/resources/views/operativos/crear.blade.php ENDPATH**/ ?>