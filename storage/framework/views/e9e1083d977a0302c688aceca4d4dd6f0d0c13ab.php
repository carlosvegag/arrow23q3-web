                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-8 col-sm-12  ">
                                        ...
                                        <?php echo Form::model($concepto, ['method' => 'PUT',  'file' => true, 'enctype' => 'multipart/form-data',  'route'=>  ['codigos.update',$concepto->id]]); ?>
                            ...
                            <div class="col-sm-3  mr-5 text-center">
                                ...
                                <img class="m-auto" src="<?php echo e(asset('img/usuarios/'.$concepto->imagen)); ?>"  style="width: 230px; height:220px;"  alt="" >
                            </div>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/codigos/editarcodigo.blade.php ENDPATH**/ ?>