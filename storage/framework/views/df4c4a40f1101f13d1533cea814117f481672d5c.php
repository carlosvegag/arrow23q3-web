...
<?php $__env->startSection('contenido'); ?>
    <div class="container-fluid">
        <div class="block-header">
            <h2>Subir imagenes de avances</h2>
				...
				<div class="card">
					...
					<div class="body">
                        <div class="row clearfix">
                            ...
                            <?php endif; ?>
                            <div class="col-md-12">
                                <form action="<?php echo e(route('avances.guardarimagen')); ?>" method="POST" file="true" enctype="multipart/form-data">

                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="id_avance" value="<?php echo e($id); ?>">
                                ...
                                <br>
                                <br>
                                <label class="text-center">Ingresa imagenes de avance:</label>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projectarrow/resources/views/avances/imagen.blade.php ENDPATH**/ ?>