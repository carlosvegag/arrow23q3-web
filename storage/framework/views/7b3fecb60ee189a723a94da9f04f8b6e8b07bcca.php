                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        <form action="<?php echo e(route('registrar.Avance',$avance->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                        <div class="row clearfix">
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/avances/createHombroD.blade.php ENDPATH**/ ?>