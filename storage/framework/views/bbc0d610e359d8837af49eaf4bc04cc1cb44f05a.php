                        ...
                        <div class="col-lg-6 col-md-12">
                           <strong>Seleccione concepto padre</strong>
                            <select class="form-control show-tick text-center" name="id_codigo"  required>
                                <?php $__currentLoopData = $conceptos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $con): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($con->id); ?>" selected><strong><?php echo e($con->codigo); ?></strong> <?php echo e($con->concepto); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/conceptos/crear.blade.php ENDPATH**/ ?>