				...
				<div class="card">
					...
					<div class="body">                        
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::model($usuario, ['method' => 'PUT', 'file' => true, 'enctype' => 'multipart/form-data', 'route'=> ['usuarios.update',$usuario->id]]); ?>

                                <?php echo csrf_field(); ?>

                                <div class="col-12 text-right">
                        
                                        <img src="<?php echo e(asset('img/usuarios/'.$usuario->photo)); ?>"  class="rounded-circle img-" width="140px" height="120px"><br>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control" id="rol" name="roles" required>
                                      ...
                                      <option value="<?php echo e($rol->name); ?>"<?php if( $rol->name === $rolSelect->name ): ?> selected <?php endif; ?>><?php echo e($rol->name); ?></option> 
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                    </select>
                                    </div>
                                </div>
                                  ...
                                  <div class="col-md-6 col-sm-12 " id="empresa" style="display:none">
                                    ...
                                    <select class="form-control show-tick "  name="empresa" id="em">
                                     ...
                                     <option value="<?php echo e($empresa->id); ?>" <?php if( $empresa->nombre === $empresaS->nombre ): ?> selected  <?php endif; ?> ><?php echo e($empresa->nombre); ?></option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                                    </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projectarrow/resources/views/usuarios/editar.blade.php ENDPATH**/ ?>