				...
				<div class="card">
					...
					<div class="body">
                        <div class="row clearfix">
                            ...
                            <?php endif; ?>
                            <div class="col-md-12">
                                <form method="POST" action="<?php echo e(route('contratos.actualizarimagen',$imagen->id)); ?>" enctype="multipart/form-data" >
                                <?php echo csrf_field(); ?>
                                ...
                                <input type="hidden" name="id_contrato" value="<?php echo e($imagen->id_contrato); ?>">
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/contratos/editarimage.blade.php ENDPATH**/ ?>