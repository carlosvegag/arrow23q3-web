                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    ...
                                    <input class="form-check-input filled-in" type="checkbox" name="empresa[]" value="<?php echo e($empresa->id); ?>" id="<?php echo e($empresa->id); ?>" <?php if(in_array($empresa->id, $empre) == True): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arrow\app\resources\views/usuarios/editar.blade.php ENDPATH**/ ?>